                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach ($pickups as $pickup)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 text-sm text-gray-500">{{ $pickup->subscription->mealPlan->ghostKitchen->business_name }}</td>
                                    ...
                                    <td class="px-6 py-4 text-sm text-right">
                                        @if ($pickup->status === 'prepared')
                                            <form method="POST" action="{{ route('admin.pickups.notify', $pickup) }}">
                                                @csrf
                                        ...
                                        @elseif ($pickup->status === 'ready')
                                            <form method="POST" action="{{ route('admin.pickups.collected', $pickup) }}">
                                                @csrf
