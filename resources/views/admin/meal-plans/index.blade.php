<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">{{ __('All Meal Plans') }}</h2>
    </x-slot>
                            ...
                            @foreach ($mealPlans as $plan)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 text-sm text-right space-x-3 whitespace-nowrap">
                                        <form action="{{ route('admin.meal-plans.toggle', $plan) }}" method="POST" class="inline">
                                            @csrf
                                        ...
                                        <form action="{{ route('admin.meal-plans.destroy', $plan) }}" method="POST" class="inline"
